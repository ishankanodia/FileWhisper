...
- `docs/index.html` is the GitHub Pages marketing site and embeds the install one-liners and product messaging, so changes to install commands or positioning need syncing there as well as in the README.
